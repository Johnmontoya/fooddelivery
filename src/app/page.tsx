...
import Fondo from "../../public/images/delivery.png";
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative w-full h-screen">
        ...
        <div className="z-20 w-full absolute flex-col gap-10 text-center inset-0 items-center justify-center">
      ...
      <section id="oferta" className="oferta w-full h-auto relative">
