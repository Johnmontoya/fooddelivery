    ...
    <>
      ...
      <section className="relative w-full h-screen">
        <div className="delivery">
          <div className="z-20 w-full flex-col gap-10 text-center items-center justify-center">
            <div className="w-full lg:w-1/2 flex flex-row text-white mt-8 px-10 lg:px-0 mx-auto pt-12">
            ...
            <div className="mt-4">
              ...
              <div className="locationa max-w-7xl flex flex-col-reverse lg:flex-row gap-8 justify-center items-center py-8 mx-auto">
                ...
                <div className="w-9/12 sm:w-1/3 h-full">
                  <Image src={Map} className="object-cover border-4 sm:border-slate-800 rounded-none sm:rounded-lg drop-shadow-2xl" alt="Map Location"/>
                </div>
              </div>
            </div>
          </div>
